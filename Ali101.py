...
print( green_color +'''
 ...
 __   __  _______  __    _  ______   _______  _______  __   __  _______ 
|  | |  ||   _   ||  |  | ||      | |       ||       ||  |_|  ||       |
|  |_|  ||  |_|  ||   |_| ||  _    ||  _____||   _   ||       ||    ___|
|       ||       ||       || | |   || |_____ |  | |  ||       ||   |___ 
|       ||       ||  _    || |_|   ||_____  ||  |_|  ||       ||    ___|
|   _   ||   _   || | |   ||       | _____| ||       || ||_|| ||   |___ 
|__| |__||__| |__||_|  |__||______| |_______||_______||_|   |_||_______|
                                                                          
                                                                          
           

==============================================
[developer] => MR-HANDSOME
[developer_snapchat] => MR-HANDSOME
[Edting] => HANDSOME
[insta] => Mr__handsome__official 
[snap] => MR-HANDSOME
==============================================
